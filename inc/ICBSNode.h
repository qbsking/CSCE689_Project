...
public:
	...
	// duplicate of conflicts
	std::list<std::shared_ptr<Conflict>> dup_rectSemiConf;
	std::list<std::shared_ptr<Conflict>> dup_rectNonConf;
	std::list<std::shared_ptr<Conflict>> dup_cardinalConf;
	std::list<std::shared_ptr<Conflict>> dup_semiConf;
	std::list<std::shared_ptr<Conflict>> dup_nonConf;
	std::list<std::shared_ptr<Conflict>> dup_unknownConf;
	int dup_Ncollisions;
	int dup_num;
